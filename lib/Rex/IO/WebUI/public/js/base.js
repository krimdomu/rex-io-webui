  ...
  $(document).ready(function() {
    ...
    $("li.has-sub").each(function(idx, elem) {
      $(elem).click(function(event) {
        ...
        // check if click is from mnu-item

        if(typeof classes == "undefined" || ! classes.match(/mnu\-item/)) {
          console.log("no click from mnu-item");
          $(elem).trigger("mnuclick", [event.target]);
          ui.trigger_has_sub_click(this, event);
          return;
        }
        if($(elem).find("ul.sub").css("display") == "none") {
          $(elem).find("ul.sub").show();
          $(elem).find("a.mnu-icon-arrow-left").addClass("mnu-icon-arrow-down").removeClass("mnu-icon-arrow-left");
        }
        else {
          $(elem).find("ul.sub").hide();
          $(elem).find("a.mnu-icon-arrow-down").addClass("mnu-icon-arrow-left").removeClass("mnu-icon-arrow-down");
        }
